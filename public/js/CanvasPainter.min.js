...
ischool.CanvasResizer.handle=function(f){var b=f.containerID,d=f.afterResizedHandler,g=0,e=0;ischool.WindowResizeHandler.handle(function(){c()});var c=function(){g=$("#"+b).width()-3;e=$("#"+b).height()-3;var a=g,c=e;$("#"+b).html("");$("<canvas id='myCanvas' width='"+a+"' height='"+c+"' style='padding: 0px; margin: 0px; border: 0px; overflow: hidden;'></canvas>").appendTo("#"+b);d&&d()};c()};
$.fn.drawTouch=function(f){var b=$.extend({onDrawing:null,onStart:null,onEnd:null,lineWidth:4,lineColor:"#000000"},f);return this.each(function(){var d=this.getContext("2d");d.lineWidth=b.lineWidth;var g=$(this).offset().left,e=$(this).offset().top;$(this).on("touchstart",function(c){var a=c.originalEvent.changedTouches[0];d.beginPath();d.lineJoin="round";d.lineCap="round";c=Math.floor(a.pageX-g);a=Math.floor(a.pageY-e);d.moveTo(c,a);if(b.onStart)b.onStart();if(b.onDrawing)b.onDrawing({time:(new Date).getTime(),
x:c,y:a})});$(this).on("touchmove",function(c){var a=c.originalEvent.changedTouches[0];c.preventDefault();c=Math.floor(a.pageX-g);a=Math.floor(a.pageY-e);d.lineTo(c,a);d.strokeStyle=b.lineColor;d.stroke();if(b.onDrawing)b.onDrawing({time:(new Date).getTime(),x:c,y:a})});$(this).on("touchend",function(d){if(b.onEnd)b.onEnd()})})};
$.fn.drawMouse=function(f){var b=$.extend({onDrawing:null,onStart:null,onEnd:null,lineWidth:4,lineColor:"#000000"},f);return this.each(function(){var d=this.getContext("2d");d.lineWidth=b.lineWidth;var g=$(this).offset().left,e=$(this).offset().top,c=0;$(this).on("mousedown",function(a){c=1;d.beginPath();d.lineJoin="round";d.lineCap="round";var f=Math.floor(a.pageX-g);a=Math.floor(a.pageY-e);d.moveTo(f,a);if(b.onStart)b.onStart();if(b.onDrawing)b.onDrawing({time:(new Date).getTime(),x:f,y:a})});$(this).on("mousemove",
function(a){if(c){var f=Math.floor(a.pageX-g);a=Math.floor(a.pageY-e);d.lineTo(f,a);d.strokeStyle=b.lineColor;d.stroke();if(b.onDrawing)b.onDrawing({time:(new Date).getTime(),x:f,y:a})}});$(this).on("mouseup",function(a){c=0;if(b.onEnd)b.onEnd()})})};ischool=ischool||{};ischool.StrokePlayer={};
...
2;console.log(" == isInterrupted ==  currentIndex : "+a);d&&d();return}var n=c[b],u=n.time-p;if(u<t)e.lineTo(n.x,n.y),e.stroke(),console.log(b+" : ("+n.x+","+n.y+") , count :"+c.length+","+u+","+t);else break}b>=c.length?(g=2,d&&d()):(a=b,window.setTimeout(v,s))}};return{draw:function(a,b){r=a;s=b;q=!1;v()},getStatus:function(){return g},stop:function(){q=!0}}},ischool=ischool||{};ischool.Painter={};
